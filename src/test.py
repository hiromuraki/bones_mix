...
def test_inference_pipeline(video_name: str):
    ...
    Serializer.save_keypoints_to_pickle(kp_2d_coco17, out_dir / "2d_kp_rtmpose_coco17.pkl")
    ...
    Serializer.save_keypoints_to_pickle(kp_3d_mhformer, out_dir / "3d_kp_rtmpose_to_mhformer.pkl")
